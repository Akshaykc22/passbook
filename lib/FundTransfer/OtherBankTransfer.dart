                                    ...
                                    return RadioListTile(
                                      ...
                                      onChanged: (value) {
                                       ...
                                       //   print("LIJU : $payModeGroupValue");
                                          ...
                                          print("LIJU : ${paymentType[index]["TYPE_NAME"]}");
                                        });
                                      },
                                      title: TextView(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return CustomRaisedButton(
                        ...
                        onPressed: () async {
                          ...
                          strPayMode = paymentType[payModeGroupValue]["TYPE_NAME"];

                          var response = await RestAPI().post(APis.getFuntransferLimit, params: {
                            "TranType": strPayMode,
