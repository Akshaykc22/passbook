...
class _DepositShareTransactionState extends State<DepositShareTransaction>
  ...
  List<String> shareList = ["Share","partager","compartir","compartilhar"];
  List<String> typeList = ["Type","Taper","Tipo","Tipo"];
  List<String> creditList = ["Credit","Crédit","Crédito","Crédito"];
  List<String> debitList = ["Debit","Débit","Débito","Débito"];
                              ...
                              : TableCell(
                                  child: CustomText(
                                    children: [
                                      TextSpan(
                                          // text: "Credit",
                                          text: creditList[int.parse(languageId)],
                                      ...
                                      TextSpan(
                                          // text: "Debit",
                                          text: debitList[int.parse(languageId)],
                                    ...
                                    TableCell(
                                      child: isShare
                                          ...
                                          : TextView(
                                              ...
                                              textAlign: TextAlign.end,
                                              fontWeight: FontWeight.bold,
                                              color: transactionList[index].tranType.trim().toLowerCase() == 'c'
                                                  ? Colors.green
                                                  : Colors.red,
                                            ),
                                    ),
